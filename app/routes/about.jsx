...
export default function AboutPage() {
  const pillars = [
    ...
    { icon:'🌿', label:'Pantry-First',         desc:'Every protocol begins with what you already have in your pantry: ginger, garlic, chamomile. Specialty herbs come later when the foundation is built.' },
